#!/usr/bin/env bash
opts=" clipboard\n Color\n󰹑 Screenshot All\n󰨵 Screenshot Window\n󱣴 Screenshot Region"
target=$(echo -e "$opts" | rofi -theme /home/samer/.config/rofi/applets/type-2/style-1.rasi -dmenu -p 'Tools' -hover-select -me-select-entry '' -me-accept-entry MousePrimary)
case "$target" in
